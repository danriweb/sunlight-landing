...
const FeaturesList = () => {
  return (
    <section aria-label="Преимущества" className="mt-2.5 flex-base">
      <div className="mx-4 mt-14 grid w-full grid-cols-1 gap-x-4 gap-y-6 screen-440:grid-cols-2 sm:mx-8 sm:mt-16 sm:gap-x-6 md:mt-18 md:mb-4 lg:mx-14 lg:mt-20 lg:mb-5 lg:gap-8 xl:mx-22.5 xl:mb-6 xl:grid-cols-3 xl:gap-10">
...
function FeatureItem({ Icon, titleOne, titleTwo }: FeatureItemProps) {
  return (
    <li className="flex items-center gap-4 screen-440:flex-col lg:flex-row">
      ...
      <div className="text-left text-[18px]/[20px] screen-440:text-center screen-440:text-[16px]/[22px] sm:text-[18px]/[24px] lg:text-left lg:text-[22px]/[28px]">
